 ...
 * 
 * A reusable SVG line chart for displaying quality score trends over time.
 * Shows quality scores (0-10 scale) for a team member across multiple meetings.
 * Displays data points with score values and meeting dates.
 * 
 * @component
 * @example
 * ```jsx
...
export default function QualityTrendChart({
  ...
  /**
   * Generate Y-axis grid values (0, 2, 4, 6, 8, 10)
 ...
 * 
 * @typedef {Object} QualityTrendChartProps
 * @property {Array<Object>} data - Array of quality score data objects
 * @property {string} [title="Quality Trend"] - Chart title
 * @property {string} [dataKey="contribution_quality_score"] - Key name for quality score values
 * @property {string} [dateKey="meeting_date"] - Key name for date values
 * @property {number} [height=256] - Chart height in pixels
 * @property {string} [color="#f59e0b"] - Line and point color (hex, amber by default)
 * @property {number} [maxValue=10] - Maximum value for Y-axis (typically 10 for quality scores)
 * @property {string} [className=""] - Additional CSS classes
 * 
 * @typedef {Object} QualityDataPoint
